...
class FosterParentsControllerTest < ActionController::TestCase
  ...
  test "should create foster_parent" do
    assert_difference('FosterParent.count') do
      post :create, foster_parent: { address: @foster_parent.address, pet_id: @foster_parent.pet_id, email: @foster_parent.email, name: @foster_parent.name }
    end
  ...
  test "should update foster_parent" do
    patch :update, id: @foster_parent, foster_parent: { address: @foster_parent.address, pet_id: @foster_parent.pet_id, email: @foster_parent.email, name: @foster_parent.name }
